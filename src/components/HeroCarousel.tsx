...
// // ... (Asset Imports & slides array remain the same)

// export function HeroCarousel() {
//   // 1. Set duration to 0 for instant movement during the loop
//   const [emblaRef, emblaApi] = useEmblaCarousel({ 
//     loop: true,
//     dragFree: true,
//     containScroll: false
...
//     // Adjust this number (0.5) to change the speed
//     engine.location.add(0.5); 
//     engine.target.set(engine.location);
//     engine.scrollLooper.loop(1);
//     engine.rebound.set(engine.location);
//     engine.scrollBody.setTarget(engine.location);
...
//     // Stop animation on pointer down (interaction)
//     emblaApi.on("pointerDown", () => {
//       if (requestRef.current) cancelAnimationFrame(requestRef.current);
//     });

//     // Resume animation when interaction stops
...
//                 <div className="absolute inset-0 flex items-center">
//                   <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
//                     {/* Content stays visible while sliding */}
//                     <div className={`max-w-2xl text-background transition-opacity duration-500 ${selected === i ? "opacity-100" : "opacity-40"}`}>
...
//                         {s.eyebrow}
//                       </span>
//                       <h1 className="mt-6 font-heading text-4xl font-extrabold leading-[1.1] text-white md:text-5xl lg:text-6xl">
//                         {s.title} <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">{s.accent}</span> {s.tail}
//                       </h1>
...
//       {/* Navigation and Dots remain same as your original code */}
//     </section>
//   );
// }